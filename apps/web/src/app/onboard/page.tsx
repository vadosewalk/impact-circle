      ...
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <Card className="w-full max-w-2xl">
          <CardHeader className="text-center">
            ...
            <CardDescription>Your onboarding request is currently under review by our admins.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm">
                <p className="text-muted-foreground">NGO Name:</p>
                <p className="font-medium">{ngoRecord?.name}</p>
                <p className="text-muted-foreground">Reg Number:</p>
                <p className="font-medium">{ngoRecord?.registrationNumber}</p>
                <p className="text-muted-foreground">Operational Radius:</p>
                <p className="font-medium">{ngoRecord?.geoRadius} km</p>
              </div>
            </div>
          </CardContent>
          <CardFooter>
      ...
      <div className="flex min-h-screen items-center justify-center bg-background px-4">
        <Card className="w-full max-w-md text-center">
          <CardHeader>
            ...
            <CardDescription>Your organization has been granted the "Green Flag."</CardDescription>
          </CardHeader>
          <CardFooter>
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-8">
      <Card className="w-full max-w-2xl">
        <CardHeader>
          ...
          <CardDescription>Impact Circle requires a live manual audit to ensure 100% transparency.</CardDescription>
        </CardHeader>
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-orange-50 border border-orange-100 rounded-lg flex gap-3 text-orange-800">
              ...
              <div className="text-xs">
                ...
                <p className="mt-1">
                  After submitting, you'll be moved to a waiting room where an admin will schedule a Google Meet call
                  with you to verify original documents.
                </p>
              </div>
            </div>
          </CardContent>
