  ...
  return (
    <div className="mb-8 overflow-hidden rounded-3xl bg-destructive/[0.03] border border-destructive/10 p-1 shadow-sm">
      <div className="flex items-center gap-2 px-6 py-3 border-b border-destructive/10">
        ...
        <h2 className="text-sm font-black uppercase tracking-[0.2em] text-destructive">
          Critical Needs
        </h2>
      ...
      <div className="flex flex-col">
        {items.map((item, index) => (
          ...
          >
            ...
            <Badge variant="outline" className="text-[10px] uppercase font-black border-destructive/20 text-destructive group-hover:bg-destructive group-hover:text-destructive-foreground transition-all">
              {item.type}
            </Badge>
